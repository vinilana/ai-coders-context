...
export const TOOL_REGISTRY: ToolDefinition[] = [
  ...
  // GitHub Copilot
  {
    ...
    paths: {
      ...
      skillsImport: ['**/.github/skills/*/SKILL.md', '**/.github/skills/**/*.md', '**/.github/skills/**/*.prompt.md'],
      commandsExport: '.github/skills',
      commandsImport: ['**/.github/skills/**/*.prompt.md', '**/.github/skills/**/*.md'],
    },
