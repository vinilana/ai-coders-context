...
const englishMessages = {
  ...
  'commands.init.options.semantic': 'Enable semantic code analysis for richer documentation',
  ...
  'commands.plan.options.semantic': 'Enable semantic code analysis for codebase context in plan',
...
const portugueseMessages: TranslationDictionary = {
  ...
  'commands.init.options.semantic': 'Ativa análise semântica de código para documentação mais rica',
  ...
  'commands.plan.options.semantic': 'Ativa análise semântica de código para contexto do codebase no plano',
